    ...
    <div className="max-w-2xl mx-auto py-8 space-y-8 font-sans">
      ...
      {status === "valid" && verifyData && (
        <div className="space-y-6">
          {/* VALID SEAL BANNER */}
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-8 text-center space-y-3 shadow-sm">
            ...
            <p className="text-emerald-700 text-sm font-medium">
              This is an official, tamper-proof academic credential.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 space-y-4 shadow-sm">
            <div className="space-y-2">
              <h3 className="text-xs font-semibold uppercase tracking-wider text-slate-500">Issuing Authority</h3>
              <div className="flex justify-between items-center bg-slate-50 p-3 rounded-lg border border-slate-200">
                <span className="text-sm font-medium text-slate-800">Authorized Institution</span>
                <span className="font-mono text-sm text-indigo-600 bg-white px-3 py-1 rounded border border-slate-200">
            ...
            <div className="space-y-2 pt-2 border-t border-slate-100">
              <h3 className="text-xs font-semibold uppercase tracking-wider text-slate-500">Document Verification Key</h3>
              <div className="bg-slate-50 p-3 rounded-lg border border-slate-200">
                <p className="font-mono text-sm text-slate-800 break-all">{verifyData.leaf}</p>
              </div>
            </div>
          </div>
