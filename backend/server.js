...
app.get('/api/issuer/csv-template', (req, res) => {
    const header = 'studentName,degreeTitle,department,issuerAddress,email,expiryTimestamp\n';
    const issuer = '0x19992c2DE1Da16b33bE1Aef78C0f99674A839E70';

    const students = [
        `Ali Raza,BS Computer Science,Faculty of Computing,${issuer},ali.raza@example.com,0`,
        `Sara Khan,MS Data Science,Faculty of Computing,${issuer},sara.khan@example.com,0`,
        `Usman Ahmed,BS Software Engineering,Faculty of Engineering,${issuer},usman.ahmed@example.com,0`,
        `Fatima Zahra,BS Information Technology,Faculty of Computing,${issuer},fatima.zahra@example.com,0`,
        `Hamza Malik,MS Cybersecurity,Faculty of Law & Security,${issuer},hamza.malik@example.com,0`,
        `Ayesha Bibi,BS Artificial Intelligence,Faculty of Computing,${issuer},ayesha.bibi@example.com,0`,
        `Bilal Hassan,BS Computer Science,Faculty of Computing,${issuer},bilal.hassan@example.com,0`,
        `Zainab Omer,BS Software Engineering,Faculty of Engineering,${issuer},zainab.omer@example.com,0`,
        `Mustafa Ali,MS Data Science,Faculty of Computing,${issuer},mustafa.ali@example.com,0`,
        `Maryam Nawaz,BS Information Technology,Faculty of Computing,${issuer},maryam.nawaz@example.com,0`,
        `Tariq Jameel,BS Electrical Engineering,Faculty of Engineering,${issuer},tariq.jameel@example.com,0`,
        `Sana Sheikh,MS Software Engineering,Faculty of Engineering,${issuer},sana.sheikh@example.com,0`,
        `Omer Farooq,BS Computer Science,Faculty of Computing,${issuer},omer.farooq@example.com,0`,
        `Hassan Raza,BS Artificial Intelligence,Faculty of Computing,${issuer},hassan.raza@example.com,0`,
        `Khadija Bibi,MS Cybersecurity,Faculty of Law & Security,${issuer},khadija.bibi@example.com,0`,
        `Asadullah Khan,BS Software Engineering,Faculty of Engineering,${issuer},asad.khan@example.com,0`,
        `Noreen Fatima,BS Information Technology,Faculty of Computing,${issuer},noreen.fatima@example.com,0`,
        `Waqas Saeed,MS Computer Science,Faculty of Computing,${issuer},waqas.saeed@example.com,0`,
        `Zubaida Khatoon,BS Data Analytics,Faculty of Business,${issuer},zubaida.k@example.com,0`,
        `Imran Abbasi,BS Computer Science,Faculty of Computing,${issuer},imran.abbasi@example.com,0`,
        `Shahid Iqbal,MS Artificial Intelligence,Faculty of Computing,${issuer},shahid.iqbal@example.com,0`,
        `Rabia Basri,BS Software Engineering,Faculty of Engineering,${issuer},rabia.basri@example.com,0`,
        `Daniyal Muneer,BS Information Technology,Faculty of Computing,${issuer},daniyal.m@example.com,0`,
        `Areeba Tariq,MS Data Science,Faculty of Computing,${issuer},areeba.tariq@example.com,0`,
        `Zohaib Shah,BS Computer Science,Faculty of Computing,${issuer},zohaib.shah@example.com,0`
    ];
...
app.get('/api/issuer/credentials', async (req, res) => {
    try {
        ...
        const records = await Credential.find(filter)
            .select('studentName degreeTitle department leafHash merkleRoot proof revoked revokedAt issuedAt -_id')
            .sort({ issuedAt: -1 });
